...
export default function ProductList() {
  const { products, deleteProduct, toggleStatus, categories, fetchCategories } =
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-xs md:text-base text-muted-foreground font-medium italic">
            Manage your toy collection ({products.length} products)
          </p>
        </div>
        <Button
                  ...
                  <motion.tr
                    ...
                    <td className="px-4 py-3 md:px-6 md:py-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-bold uppercase italic tracking-tight text-xs md:text-sm">
                            {product.name}
                          </p>
                    ...
                    <td className="px-4 py-3 md:px-6 md:py-4">
                      <Badge
                        variant="secondary"
                        className="bg-secondary/30 text-[10px] uppercase tracking-widest">
                        {product.category}
                      </Badge>
                    </td>
                    <td className="px-4 py-3 md:px-6 md:py-4">
                      <p className="font-black italic text-xs md:text-sm">
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="ghost"
                            size="icon"
                            className="rounded-full hover:bg-secondary/20 h-8 w-8">
                            <MoreVertical className="h-4 w-4" />
                          </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent
                          align="end"
                          className="w-48 p-2 rounded-2xl border-secondary/20">
                          <DropdownMenuItem
                            onClick={() =>
                              ...
                              if (
                                ...
                                if (res.success) {
                                  toast({
                                    title: "DELETED",
                                    description:
                                      "Toy has been permanently removed.",
                                  });
                                } else {
                                  toast({
                                    title: "ERROR",
                                    description:
                                      res.error || "Failed to delete toy",
                                    variant: "destructive",
                                  });
                                }
                              }
