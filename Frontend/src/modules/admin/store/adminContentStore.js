...
const defaultContent = {
  homePage: {
    hero: {
      ...
      images: ["/assets/products/WhatsApp Image 2026-01-10 at 16.10.54.jpeg"],
    ...
    specialOffers: {
      ...
      offerSets: [
        ...
        },
        {
          id: 2,
          images: [
            "/assets/advertisment/4.png",
            "/assets/advertisment/5.png",
            "/assets/advertisment/6.png",
          ],
        },
        {
          id: 3,
          images: [
            "/assets/advertisment/7.png",
            "/assets/advertisment/8.png",
            "/assets/advertisment/4.png",
          ],
        },
      ],
  ...
  contactPage: {
    header: {
      title: "GET IN TOUCH",
      subtitle:
        "Have questions about our electric wonders? Our team is here to help you gear up.",
    },
    contactInfo: {
  ...
  experiencePage: {
    ...
    desktopScrolls: [
      ...
      },
      {
        ...
        heading: "Precision Engineering.",
        description:
          "Every component designed for maximum performance and durability.",
      },
      {
        id: 3,
        start: 0.55,
        ...
        heading: "Ultra-High Quality.",
        description:
          "Materials sourced from the future. Built to last a lifetime.",
      },
      {
        id: 4,
        start: 0.85,
