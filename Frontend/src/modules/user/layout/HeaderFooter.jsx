  ...
  <>
    {[
      ...
      <Link
        ...
        {link.name}
        {!mobile && (
          <motion.span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-300 shadow-glow" />
        )}
      </Link>
    ))}
  </>
          ...
          <div className="flex items-center gap-2 lg:gap-12 shrink-0">
            ...
            <div className="lg:hidden">
              <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                ...
                <SheetContent
                  side="left"
                  className="w-[280px] flex flex-col pt-10 glass border-r border-border/10 overflow-y-auto">
            ...
            <Link to="/" className="flex items-center gap-1 sm:gap-2 group">
              <motion.div
                ...
                <span className="text-base sm:text-lg md:text-2xl font-black italic tracking-tighter text-foreground/60 group-hover:text-primary transition-colors">
                  ELECTRICI{" "}
                </span>
                <span className="text-base sm:text-lg md:text-2xl font-black italic tracking-tighter text-primary drop-shadow-glow ml-1">
                  TOYS-HUB
                </span>
              </motion.div>
            </Link>
              ...
              {mobileSearchExpanded && (
                <motion.div
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-6 w-6 shrink-0 ml-1 hover:text-red-500"
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 text-center md:text-left">
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Revolutionizing playtime with high-quality electric toys. We combine
            safety, innovation, and pure fun to create unforgettable experiences
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4 pt-4 justify-center md:justify-start">
            ...
            <a
              href="https://youtube.com/@electricitoyshub?si=ycSyQv83qhnctEyV"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.instagram.com/electricitoyshub?igsh=MTlla2Zmc3ptbGlnag=="
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.facebook.com/share/1HFUDUv9ad/"
              target="_blank"
              rel="noopener noreferrer"
