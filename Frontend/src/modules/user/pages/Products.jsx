        ...
        <div className="flex flex-col gap-0">
          ...
          <div className="mb-6 flex flex-col md:flex-row items-start md:items-center justify-between overflow-hidden bg-primary p-5 md:p-12 rounded-[1.5rem] md:rounded-[2.5rem] shadow-lg relative min-h-[140px] md:min-h-[200px]">
            ...
            <div className="relative z-10 max-w-xl flex flex-col justify-center h-full">
              <h1 className="text-4xl md:text-7xl font-black tracking-tighter uppercase italic text-primary-foreground leading-none mb-2 md:mb-3 drop-shadow-md font-['Oswald']">
                SHOP ALL
              </h1>
              <p className="text-sm md:text-lg text-primary-foreground/90 font-medium italic tracking-wide max-w-[250px] md:max-w-none">
                Discover our full range of electric excitement.
              </p>
            </div>
          </div>
              ...
              <div className="flex-shrink-0 relative z-20">
                <Select value={sortBy} onValueChange={setSortBy}>
                  ...
                  <SelectContent
                    align="end"
                    sideOffset={8}
                    className="w-[180px] bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl border border-border/20 shadow-xl z-50">
                    <SelectItem
                      value="featured"
                      className="text-[10px] font-black italic uppercase tracking-wider text-muted-foreground focus:text-foreground focus:bg-primary/20 cursor-pointer py-2.5">
                      FEATURED
                    </SelectItem>
                    <SelectItem
                      value="price-low"
          ...
          {filteredProducts.length === 0 && (
            <div className="py-24 text-center space-y-4">
              <div className="text-6xl text-muted-foreground opacity-20">
                🔍
              </div>
