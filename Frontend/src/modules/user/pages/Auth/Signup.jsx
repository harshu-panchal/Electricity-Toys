    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                const isUserExists = result.error?.toLowerCase().includes('already exists');

                toast({
                    title: isUserExists ? "ACCOUNT EXISTS" : "REGISTRATION FAILED",
                ...
                if (isUserExists) {
                    // Optional: could automatically redirect to login after a delay, 
                    // but manual is better so they read the message.
                }
            }
        } catch (error) {
            toast({
            ...
            <div className="w-full lg:w-1/2 flex flex-col p-6 md:p-12 lg:p-16 justify-start pt-28 h-full">
                <div className="max-w-md w-full mx-auto space-y-8">
                    ...
                    <div>
                        ...
                        <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-3">Create an account</h1>
                        <p className="text-base text-muted-foreground">Enter your details to create your account:</p>
                    </div>
