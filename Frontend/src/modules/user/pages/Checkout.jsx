...
export function Checkout() {
  ...
  }, [formData.paymentMethod, getTotalPrice]);
  ...
  }, [formData.paymentMethod, items, loadingShipping, calculateShipping]);
        ...
        if (formData.paymentMethod === "card") {
          ...
          if (!res) {
            toast({
              ...
              description:
                "Razorpay failed to load. Please check your connection.",
              variant: "destructive",
            });
            return;
          }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl pb-24">
      <h1 className="text-2xl md:text-4xl font-black italic tracking-tighter uppercase mb-6 text-foreground">
        Checkout
      </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-card/50 backdrop-blur-md p-6 rounded-3xl border border-border/50 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-black italic tracking-tight uppercase text-foreground">
                  Shipping Details
                </h2>
              </div>
          ...
          <div className="bg-card/50 backdrop-blur-md p-6 rounded-3xl border border-border/50 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div
                ...
                <div
                  className={`h-8 w-8 rounded-full flex items-center justify-center transition-colors ${formData.paymentMethod === "card" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}>
              ...
              <div
                ...
                <div
                  className={`h-8 w-8 rounded-full flex items-center justify-center transition-colors ${formData.paymentMethod === "cod" ? "bg-green-500 text-white" : "bg-muted text-muted-foreground"}`}>
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10px] text-muted-foreground font-medium uppercase tracking-wider">
                    Pay at doorstep
                    {shippingInfo.codEnabled &&
                      shippingInfo.codCharge > 0 &&
                      !calculatedShipping.isFreeShipping && (
                        <span className="ml-1 text-amber-500">
                          +₹{shippingInfo.codCharge}
                        </span>
                      )}
                  </p>
                </div>
        ...
        <motion.div
          ...
          <div className="bg-card p-6 rounded-3xl border border-border shadow-lg sticky top-24">
            <h2 className="text-xl font-black italic tracking-tight uppercase mb-6 text-foreground">
              Order Summary
            </h2>
              ...
              {items.map((item) => (
                <div key={item.id} className="flex gap-3 items-center group">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold uppercase text-xs line-clamp-1 text-foreground">
                      {item.name}
                    </h4>
            ...
            <div className="space-y-3 pt-6 border-t border-border">
              ...
              <div className="flex justify-between text-sm">
                ...
                {loadingShipping ? (
                  ...
                  shippingAmount === 0 ? (
                  <span className="font-black text-xs uppercase text-green-500 bg-green-500/10 px-2 py-0.5 rounded">
                    Free
                  </span>
                ) : (
                  <span className="font-bold text-foreground">
