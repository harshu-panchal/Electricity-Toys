...
export function Testimonials() {
  ...
  const reviews = React.useMemo(
    () => content.homePage?.testimonials || content.testimonials || [],
    [content],
  );
            ...
            <AnimatePresence mode="wait" custom={direction}>
              <motion.div
                ...
                {visibleReviews.map((review) => (
                  <div
                    key={review.id}
                    className="flex flex-col items-center text-center space-y-3 md:space-y-5 group">
                    ...
                    <div className="space-y-0.5 md:space-y-1">
                      <h3 className="text-base md:text-xl font-black uppercase italic tracking-tight text-foreground font-['Oswald']">
                        {review.name}
                      </h3>
