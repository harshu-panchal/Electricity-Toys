...
const slides = [
  {
    id: 1,
    image:
      "https://images.unsplash.com/photo-1593953443285-168452735460?q=80&w=2940&auto=format&fit=crop",
  ...
  },
  {
    id: 2,
    image:
      "https://images.unsplash.com/photo-1558981403-c5f9899a28bc?q=80&w=2940&auto=format&fit=crop", // Motorbike placeholder for ride-on
  ...
  },
  {
    id: 3,
    image:
      "https://images.unsplash.com/photo-1620802051782-48cb7cd75785?q=80&w=2940&auto=format&fit=crop", // E-bike
  ...
  return (
    <div
      ...
      <div className="relative h-[80vh] w-full overflow-hidden bg-gray-900">
        {slides.map((slide, index) => (
          <div
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4">
              <h1
                className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tighter drop-shadow-lg transform transition-all duration-700 translate-y-0 opacity-100"
                style={{
                  transform:
                    index === currentSlide
                      ? "translateY(0)"
              ...
              <button
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-bold text-lg transition-all transform hover:scale-105 flex items-center shadow-lg"
                style={{
                  transform:
                    index === currentSlide
                      ? "translateY(0)"
        ...
        <button
          onClick={prevSlide}
          className="absolute left-4 top-1/2 -translate-y-1/2 z-30 p-2 rounded-full bg-white/20 hover:bg-white/40 backdrop-blur-sm text-white transition-all">
          <ChevronLeft className="w-8 h-8" />
        </button>
        <button
          onClick={nextSlide}
          className="absolute right-4 top-1/2 -translate-y-1/2 z-30 p-2 rounded-full bg-white/20 hover:bg-white/40 backdrop-blur-sm text-white transition-all">
          ...
          <div className="flex flex-wrap items-center justify-between gap-y-6 md:gap-y-0">
            <div className="flex items-center space-x-3 w-1/2 md:w-auto justify-center md:justify-start group cursor-pointer">
              ...
              <div className="text-left">
                <p className="font-bold text-gray-900 text-sm uppercase leading-tight group-hover:text-blue-600 transition-colors">
                  1 Year
                </p>
                <p className="font-bold text-gray-900 text-sm uppercase leading-tight group-hover:text-blue-600 transition-colors">
                  Warranty
      ...
      <section
        className="py-24 bg-gray-50 from-gray-50 to-white bg-gradient-to-b"
        ref={addToRefs}>
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16 relative">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mt-6 text-lg font-light leading-relaxed">
              Discover our premium collection of next-generation electric rides.
            ...
            {[
              {
                ...
                price: "RS. 8,999/-",
                image:
                  "https://images.unsplash.com/photo-1593953443285-168452735460?q=80&w=600&auto=format&fit=crop",
              ...
              },
              {
                ...
                price: "RS. 23,399/-",
                image:
                  "https://images.unsplash.com/photo-1620802051782-48cb7cd75785?q=80&w=600&auto=format&fit=crop",
                category: "Mini Segway",
              },
              {
                title: "E-SCOOTERS",
                price: "RS. 15,299/-",
              ...
              },
              {
                ...
                price: "RS. 16,199/-",
                image:
                  "https://images.unsplash.com/photo-1517502839167-0e6d8c4c2317?q=80&w=600&auto=format&fit=crop",
                category: "Drifter",
              },
            ].map((item, idx) => (
                ...
                <div className="relative w-full h-[400px] rounded-3xl overflow-hidden shadow-lg group-hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors duration-500 flex flex-col items-center justify-center p-6">
                    <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 w-full text-center transform transition-all duration-500 group-hover:scale-105 rounded-xl shadow-2xl">
                      <h3 className="text-3xl font-black text-white italic tracking-tighter uppercase mb-2 drop-shadow-md">
                        {item.title}
                      </h3>
                      <div className="w-12 h-1 bg-white/50 mx-auto mb-4 rounded-full"></div>
                      <p className="text-cyan-300 font-bold text-xs uppercase tracking-widest mb-1">
                        Starts From
                      </p>
                      <p className="text-2xl text-white font-bold mb-6 drop-shadow-sm">
                        {item.price}
                      </p>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4" ref={addToRefs}>
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-blue-500 uppercase tracking-wide mb-8">
            Best Sellers
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            },
            {
              ...
              accessories: [
                "https://cdn-icons-png.flaticon.com/512/3566/3566345.png",
                "https://cdn-icons-png.flaticon.com/512/683/683072.png",
              ],
            },
            {
              name: "H8+ (Skullcandy)",
              ...
              accessories: [
                "https://cdn-icons-png.flaticon.com/512/3566/3566345.png",
                "https://cdn-icons-png.flaticon.com/512/683/683072.png",
                "https://cdn-icons-png.flaticon.com/512/10398/10398634.png",
              ],
            },
            {
            ...
            <div
              key={idx}
              className="group bg-white flex flex-col items-center">
              <div className="relative w-full mb-4 flex justify-center p-4">
                {/* Tags */}
                <div className="absolute top-0 left-0 flex flex-col gap-1">
                  {product.tag === "New" && (
                    <span className="text-[10px] font-medium text-gray-500 bg-transparent mb-1 block">
                      New
                    </span>
                  )}
                  {(product.tag === "Sale" || product.subTag === "Sale") && (
                    <span className="bg-blue-500 text-white text-[10px] uppercase font-bold px-2 py-1 rounded-sm">
                      Sale
                    </span>
                  )}
                </div>
                ...
                <img
                  src={product.image}
                  alt={product.name}
                  className="h-48 object-contain mix-blend-multiply group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              ...
              {product.accessories && product.accessories.length > 0 && (
                <div className="flex items-center gap-2 mb-4 relative">
                  {product.freeGift && (
                    <span className="absolute -left-12 top-1/2 -translate-y-1/2 bg-red-600 text-white text-[10px] font-bold p-1 rounded-full w-8 h-8 flex items-center justify-center animate-pulse z-10 border-2 border-white border-dashed">
                      FREE
                    </span>
                  )}
                  {product.accessories.map((acc, i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full border border-gray-200 p-1 flex items-center justify-center bg-white shadow-sm hover:border-blue-400 transition-colors">
                      <img
                        src={acc}
                        alt="Accessory"
              ...
              <div className="text-center w-full px-2">
                ...
                <div className="flex items-center justify-center gap-2 flex-wrap">
                  ...
                  {product.categoryId !== "Gyroor" && (
                    <span className="text-gray-400 text-xs">From</span>
                  )}
                  <span className="text-blue-500 font-bold text-sm">
                    {product.price}
                  </span>
                  <span className="bg-blue-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-sm">
                    {product.discount}
                  </span>
                </div>
              </div>
      ...
      <section className="py-20 bg-white overflow-hidden" ref={addToRefs}>
        <div className="text-center mb-12">
          <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 uppercase tracking-widest mb-3">
            @hoverpro_india
          </h2>
          <p className="text-gray-500 font-medium">
            Follow us on Instagram for daily customized rides
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div
                key={i}
                className="relative group overflow-hidden rounded-2xl aspect-square cursor-pointer shadow-md hover:shadow-xl transition-all duration-500">
                <img
                  src={img}
                  alt="Instagram Post"
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                  <div className="flex items-center gap-4 text-white">
                    <span className="flex items-center gap-1 font-bold">
                      <span className="text-pink-500">♥</span> {120 + i * 15}
                    </span>
                    <span className="flex items-center gap-1 font-bold">
                      💬 {12 + i}
                    </span>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 relative group">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <img
                  src="https://images.unsplash.com/photo-1616894562088-7e5055047ae3?q=80&w=1000&auto=format&fit=crop"
                  alt="Premium Quality"
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              <div>
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-6 font-light">
                  We are committed to our customers&apos; safety while riding
                  our electric hoverboards and leave no stone unturned to ensure{" "}
                  <b className="text-gray-900">premium segment comfort</b> and
                  safety go hand-in-hand.
                </p>
                <p className="text-gray-600 leading-relaxed font-light">
                  To provide a premium customer experience, we expose our wide
                  range of products to intensive hands-on experience by consumer
                  product experts before introducing them. We conduct several{" "}
                  <b className="text-gray-900">design testing levels</b> to
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Rigorous safety checks for every unit.
                    </p>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Long-lasting, safe lithium-ion cells.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {[
              {
                ...
                review:
                  "Excellent build quality and battery life. My son loves it! The delivery was super fast as well.",
                product: "Hoverpro Adjust...",
                color: "Galaxy",
                daysAgo: "3 months ago",
                image:
                  "https://images.unsplash.com/photo-1593953443285-168452735460?q=80&w=200&auto=format&fit=crop",
              },
              {
                name: "Edmond F.",
                location: "North Goa, GA",
                review:
                  "My kids (8 & 11) just loved it. Best gift for their birthday. Sturdy and safe.",
              ...
              },
              {
                ...
                review:
                  "With hoverpro the experience was okay to good..good is i asked customer support for help and they guided perfectly.",
                product: "H6 Eco (Galaxy)",
                color: "Multi",
                daysAgo: "5 months ago",
                image:
                  "https://images.unsplash.com/photo-1620802051782-48cb7cd75785?q=80&w=200&auto=format&fit=crop",
              },
            ].map((review, idx) => (
              <div
                key={idx}
                className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex text-yellow-400 mb-4 gap-0.5">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <Star key={i} fill="currentColor" className="w-4 h-4" />
                  ))}
                </div>
                <p className="text-gray-600 mb-6 italic line-clamp-3">
                  &quot;{review.review}&quot;
                </p>
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                ...
                <div
                  id={`faq-ans-${idx}`}
                  className="max-h-0 overflow-hidden transition-all duration-300 ease-in-out bg-gray-50/50">
      ...
      <section
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
            Join thousands of happy riders. Sign up for our newsletter to get
            exclusive deals, new launch alerts, and maintenance tips.
          </p>
